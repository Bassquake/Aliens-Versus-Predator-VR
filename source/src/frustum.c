...
*                                     F U N C T I O N S	                                    *
****************************************************************************************KJL*/
static enum FrustrumType s_current_frustrum_type = FRUSTRUM_TYPE_NORMAL;

enum FrustrumType GetFrustrumType(void)
{
	return s_current_frustrum_type;
}

void SetFrustrumType(enum FrustrumType frustrumType)
{
	s_current_frustrum_type = frustrumType;
	switch (frustrumType)
	{
		default:
