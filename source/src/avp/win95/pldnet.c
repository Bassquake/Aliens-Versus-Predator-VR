...
//		if(!(((!(messagePtr->IAmAlive)))&&(netGameData.playerData[playerIndex].characterType==NGCT_Alien)))
	...
	}
	{
		...
		if (vr_is_rendering && VR_IsIn3DMode()) {
			...
			dPtr->ObMat.mat11 =  xr_hmd_move_cos;
			dPtr->ObMat.mat12 = 0;
			dPtr->ObMat.mat13 = -xr_hmd_move_sin;
			dPtr->ObMat.mat21 = 0;
			dPtr->ObMat.mat22 = ONE_FIXED;
			dPtr->ObMat.mat23 = 0;
			dPtr->ObMat.mat31 =  xr_hmd_move_sin;
			dPtr->ObMat.mat32 = 0;
			dPtr->ObMat.mat33 =  xr_hmd_move_cos;
		}
		#endif
		ReflectObject(dPtr);
