...
/* "Swap Joysticks" - one setting, shown on General VR Configuration and on the flat
   Joystick Configuration screen. A single global rather than an array indexed by
   species, because it is not a per-species binding: it swaps the sticks for whoever
   is playing, and for the flat gamepad too. */
...
static AVPMENU_ELEMENT AvPMenu_MainMenu[] =
{
	...
	{AVPMENU_ELEMENT_GOTOMENU, {TEXTSTRING_MAINMENU_CHEATS},	{AVPMENU_CHEATS},{0},{0},	TEXTSTRING_MAINMENU_CHEATS_HELP},
...
/* Shown when aborting play from the in-game menu.
   Yes -> go to the Save Game slot picker (and quit to the main menu once a slot
   has been saved); No -> abort straight to the main menu without saving. */
static AVPMENU_ELEMENT AvPMenu_SaveProgress[] =
{
	{AVPMENU_ELEMENT_SAVEPROGRESS_YES,	{TEXTSTRING_YES},	{AVPMENU_SAVEGAME}},
	{AVPMENU_ELEMENT_QUITGAME,			{TEXTSTRING_NO}},
	{AVPMENU_ELEMENT_ENDOFMENU}
...
{
	/* Applies to BOTH sticks on every species, and to the flat gamepad - it is one
	   shared setting, which is why it sits on the general screen rather than being
	   repeated on the three per-species Controller Configuration screens (where it
	   first went, and read as though it were a per-species binding). First in the
	   list because every stick row below is described in terms of left and right. */
	...
	{AVPMENU_ELEMENT_SLIDER,		{TEXTSTRING_VRMOVEDEADZONE},	{10}, {&VRMoveDeadzone},	{0},	TEXTSTRING_VRMOVEDEADZONE_HELP},
	...
	{AVPMENU_ELEMENT_SLIDER,		{TEXTSTRING_VRSMOOTH_DEADZONE},	{10}, {&VRSmoothDeadzone},	{0},	TEXTSTRING_VRSMOOTH_DEADZONE_HELP},
...
static AVPMENU_ELEMENT AvPMenu_MarineControllerConfig[] =
{
	...
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_MARINE_VISION},	{VR_SRC_COUNT-1}, {&VRBinding[I_Marine][VR_ACT_VISION]},	{TEXTSTRING_BINDSRC_NONE},	TEXTSTRING_BIND_HELP},
...
static AVPMENU_ELEMENT AvPMenu_PredatorControllerConfig[] =
{
	...
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_ZOOM},	{VR_SRC_COUNT-1}, {&VRBinding[I_Predator][VR_ACT_VISION]},	{TEXTSTRING_BINDSRC_NONE},	TEXTSTRING_BIND_ZOOM_HELP},
	...
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_CLOAK},	{VR_SRC_COUNT-1}, {&VRBinding[I_Predator][VR_ACT_FLARE]},	{TEXTSTRING_BINDSRC_NONE},	TEXTSTRING_BIND_HELP},
...
{
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_ALIEN_CLAW},	{VR_SRC_COUNT-1}, {&VRBinding[I_Alien][VR_ACT_FIRE_PRIMARY]},	{TEXTSTRING_BINDSRC_NONE},	TEXTSTRING_BIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_ALIEN_TAIL},	{VR_SRC_COUNT-1}, {&VRBinding[I_Alien][VR_ACT_FIRE_SECONDARY]},	{TEXTSTRING_BINDSRC_NONE},	TEXTSTRING_BIND_HELP},
	...
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_ALIEN_VISION},	{VR_SRC_COUNT-1}, {&VRBinding[I_Alien][VR_ACT_VISION]},	{TEXTSTRING_BINDSRC_NONE},	TEXTSTRING_BIND_HELP},
...
/* One screen per species. Split out of Joystick Configuration because eleven binding rows
   plus the axis settings made that menu far too long to navigate; the species split also
   lets each screen name its own actions - the Marine's jetpack and flare, the Predator's
   recall disc - and hide the ones that species does not have. */
static AVPMENU_ELEMENT AvPMenu_AlienPadConfig[] =
{
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_ALIEN_CLAW},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Alien][PAD_ACT_FIRE_PRIMARY]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_ALIEN_TAIL},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Alien][PAD_ACT_FIRE_SECONDARY]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_JUMP},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Alien][PAD_ACT_JUMP]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_CROUCH},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Alien][PAD_ACT_CROUCH]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_OPERATE},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Alien][PAD_ACT_OPERATE]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_ALIEN_VISION},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Alien][PAD_ACT_VISION]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_TAUNT},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Alien][PAD_ACT_TAUNT]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},

	{AVPMENU_ELEMENT_RESETPADBINDINGS,	{TEXTSTRING_BIND_RESET},	{0},{0},{0},	TEXTSTRING_BIND_RESET_HELP},
	{AVPMENU_ELEMENT_SAVESETTINGS,	{TEXTSTRING_AVOPTIONS_USETHESESETTINGS},	{0},{0},{0},	TEXTSTRING_AVOPTIONS_USETHESESETTINGS_HELP},
	{AVPMENU_ELEMENT_ENDOFMENU}
};

static AVPMENU_ELEMENT AvPMenu_MarinePadConfig[] =
{
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_FIREPRIMARY},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_FIRE_PRIMARY]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_FIRESECONDARY},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_FIRE_SECONDARY]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_JUMP},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_JUMP]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_CROUCH},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_CROUCH]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_OPERATE},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_OPERATE]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_MARINE_VISION},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_VISION]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_TAUNT},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_TAUNT]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_JETPACK},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_SPECIAL]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_FLARE},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_FLARE]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_NEXTWEAPON},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_NEXT_WEAPON]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_PREVWEAPON},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_PREV_WEAPON]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_RELOAD},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Marine][PAD_ACT_RELOAD]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
...
static AVPMENU_ELEMENT AvPMenu_PredatorPadConfig[] =
{
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_FIREPRIMARY},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_FIRE_PRIMARY]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_FIRESECONDARY},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_FIRE_SECONDARY]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_JUMP},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_JUMP]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_CROUCH},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_CROUCH]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_OPERATE},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_OPERATE]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_VISION},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_VISION]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_ZOOM},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_VISION]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_BIND_ZOOM_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_TAUNT},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_TAUNT]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_RECALLDISC},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_SPECIAL]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_CLOAK},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_FLARE]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_NEXTWEAPON},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_NEXT_WEAPON]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_PREVWEAPON},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_PREV_WEAPON]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_RELOAD},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_RELOAD]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_BIND_GRAPPLE},	{PAD_SRC_LAST_BINDABLE}, {&PadBinding[I_Predator][PAD_ACT_GRAPPLE]},	{TEXTSTRING_PADSRC_NONE},	TEXTSTRING_PADBIND_HELP},
...
/* The authored rows. The live menu is built from these by MakeJoystickConfigMenu below,
 * which drops the species screens you are not playing while a level is running - in the
 * in-game menu only the character you are actually playing is configurable, since the
 * other two are noise at that point. Outside a level (Options off the main menu) all
 * three are shown, because no species is being played and all of it is legitimately
 * configurable in advance. Same treatment, and the same reasoning, as the VR config
 * menu above. */
static const AVPMENU_ELEMENT AvPMenu_JoystickControlsMaster[] =
{
	/* Game controller (padinput.h). The button maps live on their own per-species
	   screens: eleven rows plus the axis settings made one flat list too long to
	   navigate. The old 1999 raw-joystick options (rudder, POV hat, trackerball) are
	   gone from this screen - they describe flight sticks, not a modern pad, and the
	   arrays behind them are untouched so nothing else changes. */
	{AVPMENU_ELEMENT_SLIDER,	{TEXTSTRING_PADVERTSENSITIVITY},	{20},	{&PadVertSensitivity},	{0},	TEXTSTRING_PADSENSITIVITY_HELP},
	...
	{AVPMENU_ELEMENT_GOTOMENU,	{TEXTSTRING_PREDATORPADCONFIG_TITLE},	{AVPMENU_PREDATORPADCONFIG},	{0},	{0},	TEXTSTRING_PADCONFIG_HELP},
...
static AVPMENU_ELEMENT AvPMenu_JoystickControlsOptions[
    sizeof(AvPMenu_JoystickControlsMaster)/sizeof(AvPMenu_JoystickControlsMaster[0])];

/* inGame is passed in rather than read here: AvPMenus is static to avp_menus.c, and the
   caller is the one that knows which menu state it is setting up. */
extern void MakeJoystickConfigMenu(int inGame)
{
    const int isAlien    = (AvP.PlayerType == I_Alien);
    const int isMarine   = (AvP.PlayerType == I_Marine);
    const int isPredator = (AvP.PlayerType == I_Predator);
    unsigned int src, dst = 0;

    for (src = 0; src < sizeof(AvPMenu_JoystickControlsMaster)/sizeof(AvPMenu_JoystickControlsMaster[0]); src++)
    {
        const AVPMENU_ELEMENT *e = &AvPMenu_JoystickControlsMaster[src];

        if (inGame && e->ElementID != AVPMENU_ELEMENT_ENDOFMENU)
        {
            switch (e->a.TextDescription)
            {
                case TEXTSTRING_ALIENPADCONFIG_TITLE:    if (!isAlien)    continue; break;
                case TEXTSTRING_MARINEPADCONFIG_TITLE:   if (!isMarine)   continue; break;
                case TEXTSTRING_PREDATORPADCONFIG_TITLE: if (!isPredator) continue; break;
                default: break;
            }
        }
        AvPMenu_JoystickControlsOptions[dst++] = *e;
    }
    /* The terminator is copied with everything else, so dst is already past it. */
}
...
static AVPMENU_ELEMENT AvPMenu_InGame[] =
{
	...
	{AVPMENU_ELEMENT_GOTOMENU, {TEXTSTRING_INGAMEMENU_QUITTOMAINMENU},			{AVPMENU_SAVEPROGRESS}},
	{AVPMENU_ELEMENT_ENDOFMENU}
};
...
static AVPMENU_ELEMENT AvPMenu_Cheats[] =
{
	...
	{AVPMENU_ELEMENT_RESETCHEATS,	{TEXTSTRING_CHEATS_RESET},	{0},{0},{0},	TEXTSTRING_CHEATS_RESET_HELP},
	{AVPMENU_ELEMENT_SAVESETTINGS,	{TEXTSTRING_AVOPTIONS_USETHESESETTINGS},	{0},{0},{0},	TEXTSTRING_AVOPTIONS_USETHESESETTINGS_HELP},
...
AVPMENU AvPMenusData[]= 
{
	...
	// AVPMENU_SAVEPROGRESS (in-game abort confirm; small font to match the in-game menus)
	{AVPMENU_FONT_SMALL,	TEXTSTRING_SAVEPROGRESS_TITLE,			AvPMenu_SaveProgress,				AVPMENU_INGAME,	1},
	...
	/* Game controller button maps. Parent is AVPMENU_JOYSTICKCONTROLS so Back returns to
	   Joystick Configuration rather than jumping out to Options. */
	// AVPMENU_ALIENPADCONFIG
	{AVPMENU_FONT_SMALL,TEXTSTRING_ALIENPADCONFIG_TITLE,	AvPMenu_AlienPadConfig,	AVPMENU_JOYSTICKCONTROLS, 0},
