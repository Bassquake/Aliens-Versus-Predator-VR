...
> [!TIP]
> Check the new 0.6 update on releases page. **You will need to reupload the asset files into the new app name folder in Sidequest. Any progress made in earlier builds will be lost!** This build is mainly releases of the flat version for Android devices like phones and TVs, Windows and Linux so they can all multiplay! Aliens wall walking still broken though.
