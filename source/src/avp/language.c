...
char *GetTextString(enum TEXTSTRING_ID stringID)
{
	...
	if (stringID > MIN_NEW_TEXTSTRINGS && stringID < MAX_NEW_TEXTSTRINGS) {
		switch (stringID) {
			...
			case TEXTSTRING_BINDSRC_NONE:       return "Unbound";
			case TEXTSTRING_BINDSRC_RTRIGGER:   return "Right Trigger";
			case TEXTSTRING_BINDSRC_RGRIP:      return "Right Grip";
			case TEXTSTRING_BINDSRC_A:          return "A";
			case TEXTSTRING_BINDSRC_B:          return "B";
			case TEXTSTRING_BINDSRC_LTRIGGER:   return "Left Trigger";
			case TEXTSTRING_BINDSRC_LGRIP:      return "Left Grip";
			case TEXTSTRING_BINDSRC_X:          return "X";
			case TEXTSTRING_BINDSRC_Y:          return "Y";
